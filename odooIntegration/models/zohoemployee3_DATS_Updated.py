...
class FetchBiomaxDataforOdooDATS(models.Model):
    ...
    def attempt_db_connection(self):
        ...
        sql_query = "SELECT * FROM DestDB2.dbo.parallel_clone2 WHERE employeeID IN (108)AND DeviceName IN ('DATS In', 'DATS Out', 'TES Workstation', 'Kavi Workstation', 'Kavi In', 'Facility In', 'Facility Out', 'TES Server Room' ) AND eventTime >= '2026-01-30 00:00:00' AND eventTime <  '2026-01-31 00:00:00' ORDER BY eventTime;"
    ...
    def getandprocess_biomax_data(self, success_result):
        ...
        _logger.info("From ZohoEmployees5_DATS_Up code")
        _logger.info("=" * 80)
